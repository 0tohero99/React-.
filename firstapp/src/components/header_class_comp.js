...
class Header extends Component {
    ...
    constructor() {
        // whenever dealing with the class component , iside constructor we need to call the super method first. (to access the variable of the class by "this" keywords ). 
        super();
